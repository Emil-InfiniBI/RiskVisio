...
export const FACTORY_OPTIONS = [
  { code: 'BTL', name: 'Baettr Laholm' },
  { code: 'BTO', name: 'Baettr Olofström' },
  { code: 'BTI', name: 'Baettr Iggesund' },
  { code: 'BTX', name: 'Baettr Växjö' },
  { code: 'BTT', name: 'Baettr Torsås' },
  { code: 'GUL', name: 'Baettr Guldsmedshyttan AB' },
] as const;
...
export const loadFactoryHierarchy = (factoryCode: string): LocationNode[] => {
  ...
  return FACTORY_HIERARCHIES[factoryCode] || FACTORY_HIERARCHIES['GUL'];
};
...
export let CURRENT_FACTORY = 'GUL';
